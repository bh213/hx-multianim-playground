...
// ── Character portrait (color-driven via parameter) ──
#dialoguePortrait programmable(portraitColor:color=#4a90a4) {
    bitmap(generated(color(80, 80, $portraitColor))): 0, 0
}

#dialogueDemo programmable(portraitColor:color=#4a90a4) {
    pos: 50, 80
    ...
    dynamicRef($dialoguePortrait, portraitColor=>$portraitColor): 10, 180
...
//# sourceMappingURL=index-BcVjufsE.js.map
