...
#projectListDemo programmable() {
    ...
    placeholder(generated(cross(280, 360, #FF0000)), builderParameter("scrollableList")) {
        pos: 0, 55
        settings{panelBuildName=>list-panel, height:int=>360, width:int=>280, clickMode=>single}
    }
