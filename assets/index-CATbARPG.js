...
#hexCell programmable(col:int=0, row:int=0, status:[normal,hover]=normal,\r
                      highlight:[none,accept,reject,expensive,locked,splash]=none,\r
                      occupied:bool=false, cellColor:color=#222244,\r
                      dmgText:string="", showDmg:bool=false) {\r
    ...
    @(highlight=>splash)    graphics(polygon(#2a2a3a, filled, 24, 0, 45, 12, 45, 36, 24, 48, 3, 36, 3, 12)): -24, -24\r
    ...
    @(highlight=>locked)    apply { filter: group(grayscale(0.6), brightness(0.6)) }\r
    @(highlight=>splash)    apply { filter: glow(#8888FF, 0.3, 4) }\r
    @(occupied=>true)   graphics(polygon($cellColor, filled, 24, 6, 39, 15, 39, 33, 24, 42, 9, 33, 9, 15)): -24, -24\r
    // Damage text overlay — centered on hex origin (0,0)\r
    @(showDmg=>true) text(m5x7, $dmgText, #FF4444, center, 42): -21, -6\r
...
\r
    ...
    text(m5x7, "Row1:weapons Row2:potions Row3:premium", #555555): 0, 8\r
    #rectLog(updatable) text(m5x7, "Drag items — 4 highlight states", #888888): 0, 22\r
...
\r
    ...
    text(m5x7, "Dmg preview, splash, tooltip", #555555): 370, 8\r
    ...
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("snapChk")):556, 4\r
    text(m5x7, "Snap", #aaaacc): 574, 6\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("addRingBtn")):612, 2\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("remRingBtn")):668, 2\r
\r
...
layouts {
    ...
    #navCards list {
        ...
        point: 680, 594
        point: 840, 594
        // Game-Like Demos (9, wraps to 2 rows)
        point: 40, 652
        point: 200, 652
        point: 360, 652
        point: 520, 652
...
//# sourceMappingURL=index-CATbARPG.js.map
