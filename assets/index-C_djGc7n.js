 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(F,R){var A=F.length;F.push(R);e:for(;0<A;){var O=A-1>>>1,N=F[O];if(0<r(N,R))F[O]=R,F[A]=N,A=O;else break e}}function t(F){return F.length===0?null:F[0]}function a(F){if(F.length===0)return null;var R=F[0],A=F.pop();if(A!==R){F[0]=A;e:for(var O=0,N=F.length,Ln=N>>>1;O<Ln;){var te=2*(O+1)-1,Ve=F[te],ke=te+1,je=F[ke];if(0>r(Ve,A))ke<N&&0>r(je,Ve)?(F[O]=je,F[ke]=A,O=ke):(F[O]=Ve,F[te]=A,O=te);else if(ke<N&&0>r(je,A))F[O]=je,F[ke]=A,O=ke;else break e}}return R}function r(F,R){var A=F.sortIndex-R.sortIndex;return A!==0?A:F.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();e.unstable_now=function(){return o.now()-l}}var d=[],f=[],b=1,x=null,m=3,w=!1,S=!1,_=!1,P=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,s=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function c(F){for(var R=t(f);R!==null;){if(R.callback===null)a(f);else if(R.startTime<=F)a(f),R.sortIndex=R.expirationTime,n(d,R);else break;R=t(f)}}function p(F){if(_=!1,c(F),!S)if(t(d)!==null)S=!0,gt(h);else{var R=t(f);R!==null&&On(p,R.startTime-F)}}function h(F,R){S=!1,_&&(_=!1,u(y),y=-1),w=!0;var A=m;try{for(c(R),x=t(d);x!==null&&(!(x.expirationTime>R)||F&&!I());){var O=x.callback;if(typeof O=="function"){x.callback=null,m=x.priorityLevel;var N=O(x.expirationTime<=R);R=e.unstable_now(),typeof N=="function"?x.callback=N:x===t(d)&&a(d),c(R)}else a(d);x=t(d)}if(x!==null)var Ln=!0;else{var te=t(f);te!==null&&On(p,te.startTime-R),Ln=!1}return Ln}finally{x=null,m=A,w=!1}}var g=!1,v=null,y=-1,C=5,T=-1;function I(){return!(e.unstable_now()-T<C)}function ue(){if(v!==null){var F=e.unstable_now();T=F;var R=!0;try{R=v(!0,F)}finally{R?nn():(g=!1,v=null)}}else g=!1}var nn;if(typeof s=="function")nn=function(){s(ue)};else if(typeof MessageChannel<"u"){var ht=new MessageChannel,Sr=ht.port2;ht.port1.onmessage=ue,nn=function(){Sr.postMessage(null)}}else nn=function(){P(ue,0)};function gt(F){v=F,g||(g=!0,nn())}function On(F,R){y=P(function(){F(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(F){F.callback=null},e.unstable_continueExecution=function(){S||w||(S=!0,gt(h))},e.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):C=0<F?Math.floor(1e3/F):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(d)},e.unstable_next=function(F){switch(m){case 1:case 2:case 3:var R=3;break;default:R=m}var A=m;m=R;try{return F()}finally{m=A}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(F,R){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var A=m;m=F;try{return R()}finally{m=A}},e.unstable_scheduleCallback=function(F,R,A){var O=e.unstable_now();switch(typeof A=="object"&&A!==null?(A=A.delay,A=typeof A=="number"&&0<A?O+A:O):A=O,F){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=A+N,F={id:b++,callback:R,priorityLevel:F,startTime:A,expirationTime:N,sortIndex:-1},A>O?(F.sortIndex=A,n(f,F),t(d)===null&&F===t(f)&&(_?(u(y),y=-1):_=!0,On(p,A-O))):(F.sortIndex=N,n(d,F),S||w||(S=!0,gt(h))),F},e.unstable_shouldYield=I,e.unstable_wrapCallback=function(F){var R=m;return function(){var A=m;m=R;try{return F.apply(this,arguments)}finally{m=A}}}})(hs);ms.exports=hs;var Wc=ms.exports;/**
 * @license React
...
#rectCell programmable(col:int=0, row:int=0, status:[normal,hover]=normal,\r
                       highlight:bool=false, rejectHighlight:bool=false,\r
    ...
    @(rejectHighlight=>true) bitmap(generated(color(52, 52, #3a2020))): 0, 0\r
    @(highlight=>true)       apply { filter: glow(#44FF44, 0.4, 6) }\r
    @(rejectHighlight=>true) apply { filter: glow(#FF4444, 0.4, 6) }\r
...
\r
    ...
    text(m5x7, "Row 1: weapons, Row 2: potions, Row 3: any", #555555): 0, 8\r
    #rectLog(updatable) text(m5x7, "Drag typed items — red = rejected", #888888): 0, 22\r
...
\r
    ...
    text(m5x7, "Animated cell add/remove", #555555): 370, 8\r
...
\r
    ...
    text(m5x7, "Typed items + source tracking", #555555): 770, 8\r
    ...
    text(m5x7, "Weapons", #8888aa): 770, 48\r
    text(m5x7, "Potions", #7799bb): 890, 48\r
...
//# sourceMappingURL=index-C_djGc7n.js.map
