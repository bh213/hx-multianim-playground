 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(F,R){var E=F.length;F.push(R);e:for(;0<E;){var M=E-1>>>1,D=F[M];if(0<a(D,R))F[M]=R,F[E]=D,E=M;else break e}}function t(F){return F.length===0?null:F[0]}function r(F){if(F.length===0)return null;var R=F[0],E=F.pop();if(E!==R){F[0]=E;e:for(var M=0,D=F.length,In=D>>>1;M<In;){var te=2*(M+1)-1,je=F[te],Se=te+1,Ve=F[Se];if(0>a(je,E))Se<D&&0>a(Ve,je)?(F[M]=Ve,F[Se]=E,M=Se):(F[M]=je,F[te]=E,M=te);else if(Se<D&&0>a(Ve,E))F[M]=Ve,F[Se]=E,M=Se;else break e}}return R}function a(F,R){var E=F.sortIndex-R.sortIndex;return E!==0?E:F.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();e.unstable_now=function(){return o.now()-l}}var u=[],p=[],b=1,x=null,m=3,w=!1,k=!1,_=!1,T=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,s=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function c(F){for(var R=t(p);R!==null;){if(R.callback===null)r(p);else if(R.startTime<=F)r(p),R.sortIndex=R.expirationTime,n(u,R);else break;R=t(p)}}function f(F){if(_=!1,c(F),!k)if(t(u)!==null)k=!0,gt(h);else{var R=t(p);R!==null&&Mn(f,R.startTime-F)}}function h(F,R){k=!1,_&&(_=!1,d(y),y=-1),w=!0;var E=m;try{for(c(R),x=t(u);x!==null&&(!(x.expirationTime>R)||F&&!N());){var M=x.callback;if(typeof M=="function"){x.callback=null,m=x.priorityLevel;var D=M(x.expirationTime<=R);R=e.unstable_now(),typeof D=="function"?x.callback=D:x===t(u)&&r(u),c(R)}else r(u);x=t(u)}if(x!==null)var In=!0;else{var te=t(p);te!==null&&Mn(f,te.startTime-R),In=!1}return In}finally{x=null,m=E,w=!1}}var g=!1,v=null,y=-1,$=5,P=-1;function N(){return!(e.unstable_now()-P<$)}function de(){if(v!==null){var F=e.unstable_now();P=F;var R=!0;try{R=v(!0,F)}finally{R?nn():(g=!1,v=null)}}else g=!1}var nn;if(typeof s=="function")nn=function(){s(de)};else if(typeof MessageChannel<"u"){var ht=new MessageChannel,ka=ht.port2;ht.port1.onmessage=de,nn=function(){ka.postMessage(null)}}else nn=function(){T(de,0)};function gt(F){v=F,g||(g=!0,nn())}function Mn(F,R){y=T(function(){F(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(F){F.callback=null},e.unstable_continueExecution=function(){k||w||(k=!0,gt(h))},e.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<F?Math.floor(1e3/F):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(u)},e.unstable_next=function(F){switch(m){case 1:case 2:case 3:var R=3;break;default:R=m}var E=m;m=R;try{return F()}finally{m=E}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(F,R){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var E=m;m=F;try{return R()}finally{m=E}},e.unstable_scheduleCallback=function(F,R,E){var M=e.unstable_now();switch(typeof E=="object"&&E!==null?(E=E.delay,E=typeof E=="number"&&0<E?M+E:M):E=M,F){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=E+D,F={id:b++,callback:R,priorityLevel:F,startTime:E,expirationTime:D,sortIndex:-1},E>M?(F.sortIndex=E,n(p,F),t(u)===null&&F===t(p)&&(_?(d(y),y=-1):_=!0,Mn(f,E-M))):(F.sortIndex=D,n(u,F),k||w||(k=!0,gt(h))),F},e.unstable_shouldYield=N,e.unstable_wrapCallback=function(F){var R=m;return function(){var E=m;m=R;try{return F.apply(this,arguments)}finally{m=E}}}})(hs);ms.exports=hs;var Hc=ms.exports;/**
 * @license React
...
// Hover tooltips (UITooltipHelper) and click panels (UIPanelHelper)
...
#panelActions programmable() {
    ...
    point {
        ...
        interactive(110, 22, "info"): 0, 0
    }
}

#panelColors programmable() {
    ...
    point {
        ...
        interactive(24, 22, "colorRed"): 0, 0
        bitmap(generated(color(24, 22, #44ff44))): 28, 0
        interactive(24, 22, "colorGreen"): 28, 0
        bitmap(generated(color(24, 22, #4488ff))): 56, 0
        interactive(24, 22, "colorBlue"): 56, 0
    }
    ...
    point {
        ...
        interactive(24, 22, "colorYellow"): 0, 0
        bitmap(generated(color(24, 22, #ff44ff))): 28, 0
        interactive(24, 22, "colorPurple"): 28, 0
        bitmap(generated(color(24, 22, #44ffff))): 56, 0
        interactive(24, 22, "colorCyan"): 56, 0
    }
}

#panelManual programmable() {
    ...
    point {
        pos: 10, 40
        bitmap(generated(color(60, 18, #553333))): 0, 0
        text(m6x11, "Close", #ff8888, center, 60): 0, 3
        interactive(60, 18, "closeBtn"): 0, 0
    }
}

// ─── Combo Panel (for Section 4) ───────────────────────────

#panelCombo programmable() {
    ninepatch("ui", "Window_3x3_idle", 140, 78): 0, 0
    text(m5x7, "Item Options", #888888, left, 120): 10, 6

    point {
        pos: 10, 22
        bitmap(generated(color(120, 22, #334466))): 0, 0
        text(m6x11, "Equip", #7fdbda, center, 120): 0, 5
        interactive(120, 22, "comboEquip"): 0, 0
    }

    point {
        pos: 10, 48
        bitmap(generated(color(120, 22, #553333))): 0, 0
        text(m6x11, "Discard", #ff8888, center, 120): 0, 5
        interactive(120, 22, "comboDiscard"): 0, 0
    }
}
...
#tooltipsPanelsDemo programmable() {
    ...
    bitmap(generated(color(700, 1, #7fdbda33))): 0, 22
    text(exo2_light_14, "Hover to see tooltips at different positions (Above, Below, Left, Right).", #aaaaaa, left, 700): 0, 30

    // Above
    point {
        pos: 0, 60
        bitmap(generated(color(120, 40, #334466))): 0, 0
        text(m6x11, "Above", #7fdbda, center, 120): 0, 13
        interactive(120, 40, "btnAbove", tooltip => "tooltipSimple", label => "Above!"): 0, 0
    }
    ...
    point {
        ...
        interactive(120, 40, "btnBelow", tooltip => "tooltipSimple", label => "Below!"): 0, 0
    }
    ...
    point {
        ...
        interactive(120, 40, "btnLeft", tooltip => "tooltipSimple", label => "Left!"): 0, 0
    }
    ...
    point {
        ...
        interactive(120, 40, "btnRight", tooltip => "tooltipSimple", label => "Right!"): 0, 0
    }
    ...
    text(exo2_light_14, "Metadata-driven content. Instant (0s), default (0.3s), and slow (1.0s) delays.", #aaaaaa, left, 700): 0, 175
    ...
    point {
        ...
        interactive(140, 50, "itemSword", tooltip => "tooltipItem", name => "Iron Sword", rarity => "Common", damage => "Damage: 12", color => "#aaaaaa"): 0, 0
    }
    ...
    point {
        ...
        interactive(140, 50, "itemShield", tooltip => "tooltipItem", name => "Mana Shield", rarity => "Rare", damage => "Block: 28", color => "#7fdbda"): 0, 0
    }
    ...
    point {
        ...
        interactive(140, 50, "itemCrown", tooltip => "tooltipItem", name => "Dragon Crown", rarity => "Legendary", damage => "Power: 99", color => "#ffeb3b"): 0, 0
    }
    ...
    text(exo2_light_14, "Click to open panels. OutsideClick auto-closes; Manual requires close button.", #aaaaaa, left, 700): 0, 330

    // Actions panel trigger
    point {
        pos: 0, 360
        bitmap(generated(color(120, 40, #443366))): 0, 0
        text(m6x11, "Actions", #ffeb3b, center, 120): 0, 13
        interactive(120, 40, "triggerActions", panel => "panelActions"): 0, 0
    }

    // Color picker trigger
    point {
        pos: 140, 360
        bitmap(generated(color(120, 40, #336644))): 0, 0
        text(m6x11, "Colors", #ffeb3b, center, 120): 0, 13
        interactive(120, 40, "triggerColors", panel => "panelColors"): 0, 0
    }

    // Manual close trigger
    point {
        pos: 280, 360
        bitmap(generated(color(120, 40, #664433))): 0, 0
        text(m6x11, "Manual", #ffeb3b, center, 120): 0, 13
        interactive(120, 40, "triggerManual", panel => "panelManual"): 0, 0
    }
    ...
    point {
        ...
        interactive(160, 50, "comboItem", tooltip => "tooltipRich", panel => "panelCombo", name => "Magic Ring", desc => "Hover=tooltip, Click=panel", color => "#ff88ff"): 0, 0
    }
...
//# sourceMappingURL=index-CwFxtvaM.js.map
