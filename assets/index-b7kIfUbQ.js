 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Nc=be,zc=Symbol.for("react.element"),Oc=Symbol.for("react.fragment"),Lc=Object.prototype.hasOwnProperty,Mc=Nc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Hc={key:!0,ref:!0,__self:!0,__source:!0};function ps(e,n,t){var a,r={},i=null,o=null;t!==void 0&&(i=""+t),n.key!==void 0&&(i=""+n.key),n.ref!==void 0&&(o=n.ref);for(a in n)Lc.call(n,a)&&!Hc.hasOwnProperty(a)&&(r[a]=n[a]);if(e&&e.defaultProps)for(a in n=e.defaultProps,n)r[a]===void 0&&(r[a]=n[a]);return{$$typeof:zc,type:e,key:i,ref:o,props:r,_owner:Mc.current}}lr.Fragment=Oc;lr.jsx=ps;lr.jsxs=ps;ts.exports=lr;var D=ts.exports,ni={},fs={exports:{}},we={},ms={exports:{}},hs={};/**
 * @license React
...
\r
#rectCell programmable(col:int=0, row:int=0, status:[normal,hover]=normal, highlight:bool=false) {\r
    @(highlight=>true)  bitmap(generated(color(52, 52, #2a3a2a))): 0, 0\r
    @(highlight=>false)  bitmap(generated(color(52, 52, #1a1a2e))): 0, 0\r
    @(status=>hover) apply { filter: glow(#FFFF00, 0.3, 4) }\r
    graphics(rect(#333355, 1.0, 52, 52)): 0, 0\r
}\r
\r
#hexCell programmable(col:int=0, row:int=0, status:[normal,hover]=normal, highlight:bool=false,\r
                      occupied:bool=false, cellColor:color=#222244) {\r
    @(highlight=>true)  graphics(polygon(#2a3a2a, filled, 24, 0, 45, 12, 45, 36, 24, 48, 3, 36, 3, 12)): -24, -24\r
    @(highlight=>false) graphics(polygon(#1a1a2e, filled, 24, 0, 45, 12, 45, 36, 24, 48, 3, 36, 3, 12)): -24, -24\r
...
\r
#gridCard programmable(status:[normal,hover,pressed,disabled]=normal, cardName:string="Spell", cardColor:color=#3366AA) {\r
    ...
    text(m5x7, $cardName, #ffffff, center, 100): 0, 110\r
...
\r
    ...
    text(m5x7, "Rect Grid + Drag", #7fdbda): 0, -4\r
    text(m5x7, "Drag items between cells", #555555): 0, 8\r
    #rectLog(updatable) text(m5x7, "Click or drag items", #888888): 0, 22\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("resetBtn")):138, 2\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("addRowBtn")):194, 2\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("remRowBtn")):250, 2\r
\r
    // === CENTER: Hex Grid + Cards ===\r
    text(m5x7, "Hex Grid + Cards", #cc9966): 370, -4\r
    text(m5x7, "Play cards on hex cells", #555555): 370, 8\r
    #hexLog(updatable) text(m5x7, "Draw and play cards", #888888): 370, 22\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("drawBtn")):500, 2\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("addRingBtn")):556, 2\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("remRingBtn")):612, 2\r
\r
    // === RIGHT: Grid-to-Grid ===\r
    text(m5x7, "Grid to Grid", #66cc99): 770, -4\r
    text(m5x7, "Drag between grids", #555555): 770, 8\r
    #g2gLog(updatable) text(m5x7, "Move items between grids", #888888): 770, 22\r
    #storageCount(updatable) text(m5x7, "Storage: 5", #7799aa): 770, 36\r
    #loadoutCount(updatable) text(m5x7, "Loadout: 0", #7799aa): 870, 36\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("addStorBtn")):905, 2\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("remStorBtn")):961, 2\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("addLoadBtn")):1017, 2\r
    placeholder(generated(cross(10, 10, #FF0000)), builderParameter("remLoadBtn")):1073, 2\r
}\r
`,Ep=`version: 1.0
