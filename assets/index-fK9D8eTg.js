 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Nc=be,zc=Symbol.for("react.element"),Oc=Symbol.for("react.fragment"),Lc=Object.prototype.hasOwnProperty,Wc=Nc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Mc={key:!0,ref:!0,__self:!0,__source:!0};function ps(e,n,t){var a,r={},i=null,o=null;t!==void 0&&(i=""+t),n.key!==void 0&&(i=""+n.key),n.ref!==void 0&&(o=n.ref);for(a in n)Lc.call(n,a)&&!Mc.hasOwnProperty(a)&&(r[a]=n[a]);if(e&&e.defaultProps)for(a in n=e.defaultProps,n)r[a]===void 0&&(r[a]=n[a]);return{$$typeof:zc,type:e,key:i,ref:o,props:r,_owner:Wc.current}}lr.Fragment=Oc;lr.jsx=ps;lr.jsxs=ps;ts.exports=lr;var D=ts.exports,ni={},fs={exports:{}},_e={},ms={exports:{}},hs={};/**
 * @license React
...
#featureShowcase programmable() {
  ...
  point {
    ...
    stateAnim construct("state1",
      "state1" => sheet "crew2", marine_r_shooting_u, 10, loop, center
    ): 32, 47

    text(m6x11, "killed", #888888): 80, 0
    bitmap(generated(color(64, 64, #222233))): 80, 15
    stateAnim construct("state1",
      "state1" => sheet "crew2", marine_l_killed, 10, loop, center
    ): 112, 47
  }
  ...
  point {
    ...
    pixels (
      ...
      line 40, 0, 40, 40, #ff4444
      line 0, 40, 40, 40, #44ff44
...
curves {
    ...
    // Curve operations: combine/transform other named curves
    #multiplied curve {
        multiply: [easeOutQuad, custom]
    }
    #composed curve {
        apply: easeInQuad, easeOutCubic
    }
    #inverted curve {
        invert: easeOutCubic
    }
    #scaled curve {
        scale: easeOutBack, 0.6
    }
}
...
// Screen Shake Demo
// Additive impact shake (bh.ui.ScreenShakeHelper). The #shakeStage point is the
// h2d target the helper shakes; buttons trigger different shake patterns.

#screenShakeDemo programmable() {
    pos: 40, 80

    text(exo2_16, "Screen Shake Helper", #7fdbda): 0, 0
    bitmap(generated(color(700, 1, #7fdbda33))): 0, 22
    text(exo2_light_14, "Additive impact shake — click a button to shake the stage below.", #aaaaaa, left, 700): 0, 30

    // The stage: this whole #point is shaken by ScreenShakeHelper
    #shakeStage point {
        pos: 80, 80
        ninepatch("ui", "Window_3x3_idle", 320, 200): 0, 0
        bitmap(generated(colorWithText(140, 56, #4a90a4, "IMPACT", white, exo2_16))): 90, 36
        bitmap(generated(color(48, 48, #cc4444))): 50, 130
        bitmap(generated(color(48, 48, #44cc44))): 136, 130
        bitmap(generated(color(48, 48, #4488ff))): 222, 130
    }

    // Triggers
    placeholder(generated(cross(150, 28, #FF0000)), builderParameter("btnLight")): 0, 320
    placeholder(generated(cross(150, 28, #FF0000)), builderParameter("btnHeavy")): 160, 320
    placeholder(generated(cross(180, 28, #FF0000)), builderParameter("btnRecoil")): 320, 320
    placeholder(generated(cross(180, 28, #FF0000)), builderParameter("btnLanding")): 510, 320
    placeholder(generated(cross(150, 28, #FF0000)), builderParameter("btnCurve")): 0, 358

    #shakeStatus(updatable) text(exo2_light_14, "Idle", #888888, left, 400): 170, 364
}
`,vp=`version: 1.0
...
#filtersUI programmable() {
    ...
    text(m6x11, "hue: 120 deg", #888888): 10, 115
...
// ── Character portrait (speaker-driven, crossfades between speakers) ──
#dialoguePortrait programmable(speaker:[oldman, bartender, narrator]=oldman) {
    transition { speaker: crossfade(0.25, easeoutquad) }
    @(speaker=>oldman)   bitmap(generated(color(80, 80, #4a90a4))): 0, 0
    @(speaker=>bartender) bitmap(generated(color(80, 80, #ff7f50))): 0, 0
    @(speaker=>narrator) bitmap(generated(color(80, 80, #7fdbda))): 0, 0
}

#dialogueDemo programmable(speaker:[oldman, bartender, narrator]=oldman) {
    pos: 50, 80
    ...
    // Character portrait area (color driven by dynamicRef parameter)
    ninepatch("ui", "Window_3x3_idle", 100, 100): 0, 170
    dynamicRef($dialoguePortrait, speaker=>$speaker): 10, 180
    ...
    // Choice buttons are built standalone in code (positioned at 170,385 / 460,385)
    // so their setText() re-renders — placeholder buttons inside this incremental
    // programmable would not repaint on their own setParameter.
...
// Inline atlas2: define named tile regions carved from the already-loaded "ui" sheet texture.
#uiInline atlas2(sheet("ui")) {
  chk-on: 1074, 0, 20, 20
  chk-off: 1042, 40, 20, 20
  drop: 1261, 20, 10, 10
}
...
#bitmapsAtlasShowcase programmable() {
  ...
  // Section 9: Inline atlas2 — named tiles defined in .manim (carved from the ui sheet)
  text(exo2_16, 'Inline atlas2 — bitmap(sheet("uiInline", "name")):', #cccccc): 0, 1000

  @scale(2) bitmap(sheet("uiInline", "chk-on")): 0, 1030
  @scale(2) bitmap(sheet("uiInline", "chk-off")): 60, 1030
  @scale(2) bitmap(sheet("uiInline", "drop")): 120, 1030

  text(m6x11, "chk-on", #888888): 0, 1080
  text(m6x11, "chk-off", #888888): 60, 1080
  text(m6x11, "drop", #888888): 120, 1080

  // Section 10: tileGroup — GPU-batched bitmaps merged into a single draw call
  text(exo2_16, "tileGroup — GPU-batched bitmaps:", #cccccc): 0, 1110

  tileGroup {
    bitmap(generated(color(40, 40, #cc4444))): 0, 1140
    bitmap(generated(color(40, 40, #44cc44))): 44, 1140
    bitmap(generated(color(40, 40, #4444cc))): 88, 1140
    bitmap(generated(color(40, 40, #cccc44))): 132, 1140
  }
  text(m6x11, "4 bitmaps batched into one TileGroup draw call", #888888): 0, 1190
}
`,Op=`version: 1.0
...
#pixelsGraphicsShowcase programmable() {
  ...
  point {
    pos: 720, 250
    graphics (
      ellipse(#44cc88, filled, 70, 40): 0, 0
      ellipse(#cc8844, 2, 40, 22): 0, 0
    );
    text(m6x11, "Ellipse", #888888): -35, 40
  }
...
#richTextAutofitDemo programmable() {
    ...
    // ─── Controls Row 1: Mode (radio) ───────────────────
    text(m6x11, "Mode:", #888888): 0, 65
    placeholder(generated(cross(480, 24, #FF0000)), builderParameter("modeRadio")) {
        pos: 45, 61
        settings{radioButtonBuildName=>radio}
    }

    // ─── Controls Row 2: Bounds (Width / Height) ────────
    text(m6x11, "Width:", #888888): 0, 95
    ...
    #widthValue(updatable) text(m6x11, "200", #cccccc): 262, 95

    text(m6x11, "Height:", #888888): 300, 95
    ...
    #heightValue(updatable) text(m6x11, "40", #cccccc): 562, 95

    // ─── Controls Row 3: Fonts ──────────────────────────
    text(m6x11, "Fonts:", #888888): 0, 125

    placeholder(generated(cross(20, 20, #FF0000)), builderParameter("chkPixellari")): 45, 122
    text(m6x11, "pixellari", #aaaaaa): 67, 125

    placeholder(generated(cross(20, 20, #FF0000)), builderParameter("chkDd")): 140, 122
    text(m6x11, "dd", #aaaaaa): 162, 125

    placeholder(generated(cross(20, 20, #FF0000)), builderParameter("chkM6x11")): 195, 122
    text(m6x11, "m6x11", #aaaaaa): 217, 125

    placeholder(generated(cross(20, 20, #FF0000)), builderParameter("chkM5x7")): 270, 122
    text(m6x11, "m5x7", #aaaaaa): 292, 125

    placeholder(generated(cross(20, 20, #FF0000)), builderParameter("chkM3x6")): 335, 122
    text(m6x11, "m3x6", #aaaaaa): 357, 125

    placeholder(generated(cross(20, 20, #FF0000)), builderParameter("chkF7x5")): 400, 122
    text(m6x11, "f7x5", #aaaaaa): 422, 125

    // Rich text toggle
    placeholder(generated(cross(20, 20, #FF0000)), builderParameter("chkRichText")): 480, 122
    text(m6x11, "Rich", #888888): 502, 125

    // ─── Controls Row 4: Text Input (multiline) ─────────
    text(m6x11, "Text:", #888888): 0, 154
    placeholder(generated(cross(500, 60, #FF0000)), builderParameter("textInput")) {
        pos: 35, 150
        settings{buildName=>textInput, font=>dd, placeholder=>"Type text here...", multiline=>true, inputWidth=>450, width=>500}
    }

    // ─── Display Area ───────────────────────────────────
    #statusText(updatable) text(m6x11, "Mode: Width | Bounds: 200 | Fonts: pixellari, dd, m6x11, m5x7, m3x6, f7x5 | Selected: dd", #666666): 0, 225
}
`,Mp=`version: 1.0
...
#richTextShowcase programmable(dmg:1..5=3, dmgColor:color=#FF4444, quest:[accepted,progress,complete]=accepted, equip:[sword,shield,empty]=sword) {
  ...
  // Section 17: Explicit line breaks with [br]
  text(exo2_16, "Line Breaks [br]", #7fdbda): 0, 850
  bitmap(generated(color(600, 58, #282838))): 0, 878
  richText(dd, "First line[br]second line[br]third line", white, left, 600): 8, 882
  text(m6x11, "[br] forces a line break (self-closing markup tag)", #666666): 0, 944
}
`,Hp=`version: 1.0
...
#textFontsShowcase programmable() {
  ...
  // Section 6: Additional bitmap fonts
  text(exo2_16, "More Bitmap Fonts:", #cccccc): 0, 1110

  text(m6x11, "departuremono", #aaaaaa): 0, 1140
  text(departuremono, "The quick brown fox jumps over the lazy dog 0123456789", #ffffff): 200, 1140

  text(m6x11, "f3x5 (tiny)", #aaaaaa): 0, 1160
  text(f3x5, "The quick brown fox jumps over the lazy dog 0123456789", #ffffff): 200, 1160

  text(m6x11, "o4b03", #aaaaaa): 0, 1180
  text(o4b03, "The quick brown fox jumps over the lazy dog 0123456789", #ffffff): 200, 1180

  // Section 7: ASCII / Unicode box drawing (departuremono is monospace + has box glyphs)
  text(exo2_16, "Box Drawing (departuremono):", #cccccc): 0, 1224

  // Single-line box with a title divider
  text(departuremono, "┌───────────────┐", #7fdbda): 0, 1294
  text(departuremono, "│ Single  Box   │", #ffffff): 0, 1306
  text(departuremono, "├───────────────┤", #7fdbda): 0, 1318
  text(departuremono, "│ row a │ val 1 │", #cccccc): 0, 1330
  text(departuremono, "│ row b │ val 2 │", #cccccc): 0, 1342
  text(departuremono, "└───────────────┘", #7fdbda): 0, 1354

  // Double-line box
  text(departuremono, "╔═══════════════╗", #ffcc44): 240, 1294
  text(departuremono, "║ Double  Box   ║", #ffffff): 240, 1306
  text(departuremono, "╠═══════╦═══════╣", #ffcc44): 240, 1318
  text(departuremono, "║ left  ║ right ║", #cccccc): 240, 1330
  text(departuremono, "╚═══════╩═══════╝", #ffcc44): 240, 1354

  // Rounded-corner box + tree connectors
  text(departuremono, "╭───────────────╮", #88ff88): 480, 1294
  text(departuremono, "│ Rounded Box   │", #ffffff): 480, 1306
  text(departuremono, "╰───────────────╯", #88ff88): 480, 1318
  text(departuremono, "├─ item one",        #cccccc): 480, 1336
  text(departuremono, "├─ item two",        #cccccc): 480, 1348
  text(departuremono, "└─ item three",      #cccccc): 480, 1360
}
`,jp=`version: 1.0
...
#comboStatesShowcase programmable(mode:[idle, active, warning, error]=idle, level:[low, medium, high, critical]=low, state:[on, off, standby, unknown]=on) {
  ...
  // Animate parameter-driven branch changes instead of instant pops.
  transition {
    mode: crossfade(0.15, easeoutquad)
    level: slide(left, 0.2, 30, easeoutcubic)
    state: flipX(0.25)
  }
  ...
  // Section 4: @switch — dedicated multi-state construct with block arms
  text(exo2_16, "@switch(mode) multi-state:", #cccccc): 0, 300
  point {
    pos: 0, 330
    bitmap(generated(color(120, 40, #222222))): 0, 0
    @switch(mode) {
      idle {
        bitmap(generated(color(116, 36, #334455))): 2, 2
        text(m6x11, "SWITCH: IDLE", #8888aa, center, 120): 0, 14
      }
      active {
        bitmap(generated(color(116, 36, #335533))): 2, 2
        text(m6x11, "SWITCH: ACTIVE", #88ff88, center, 120): 0, 14
      }
      warning {
        bitmap(generated(color(116, 36, #555533))): 2, 2
        text(m6x11, "SWITCH: WARN", #ffff88, center, 120): 0, 14
      }
      default {
        bitmap(generated(color(116, 36, #553333))): 2, 2
        text(m6x11, "SWITCH: ERROR", #ff8888, center, 120): 0, 14
      }
    }
  }
  text(exo2_light_14, "@switch shares the mode cycle button above", #888888, left, 300): 140, 342
}
`,Vp=`version: 1.0
...
#buttonsDemo programmable() {
    ...
    placeholder(generated(cross(200, 30, white)), builderParameter("colorTextBtn1")) {
        pos: 0, 440
        settings{text=>"Red Text", fontColor:int=>0xFFff4444}
    }
    placeholder(generated(cross(200, 30, white)), builderParameter("colorTextBtn2")) {
        pos: 220, 440
        settings{text=>"Green Text", fontColor:int=>0xFF44ff44}
    }
    placeholder(generated(cross(200, 30, white)), builderParameter("colorTextBtn3")) {
        pos: 440, 440
        settings{text=>"Gold Text", fontColor:int=>0xFFffcc44}
    }
...
#dropdownsDemo programmable() {
    ...
    text(exo2_light_14, "Sizes to fit; auto-closes when pointer leaves:", #cccccc): 0, 175

    placeholder(generated(cross(120, 30, #FF0000)), builderParameter("dropdownAutoFew")) {
        pos: 0, 195
        settings{panelBuildName=>list-panel, itemBuildName=>list-item-120, panelMode=>scalable, height:int=>300, autoCloseOnLeave=>true, closeOnOutsideClick=>true}
    }
    ...
    placeholder(generated(cross(180, 30, #FF0000)), builderParameter("dropdownWide")) {
        pos: 0, 615
        settings{dropdownBuildName=>dropdown-w, dropdown.btnWidth:int=>180, itemBuildName=>list-item-w, width:int=>180, height:int=>150, font=>"pixellari", fontColor:color=>#7fdbda}
    }
    ...
    placeholder(generated(cross(200, 40, #FF0000)), builderParameter("dropdownLarge")) {
        pos: 0, 755
        settings{dropdownBuildName=>dropdown-w, dropdown.btnWidth:int=>200, dropdown.btnHeight:int=>40, itemBuildName=>list-item-w, item.itemHeight:int=>28, width:int=>200, height:int=>150, font=>"exo2_16", fontColor:color=>#ffeb3b}
    }
...
#textInputDemo programmable() {
    ...
    placeholder(generated(cross(300, 24, #FF0000)), builderParameter("readOnlyInput")) {
        pos: 0, 248
        settings{buildName=>textInputGrey, font=>dd, text=>"This is read-only", readOnly=>true, inputWidth=>240, width=>300}
    }
    ...
    // Section: Multiline & Alphanumeric
    text(exo2_16, "Multiline & Alphanumeric", #7fdbda): 0, 500
    bitmap(generated(color(600, 1, #7fdbda33))): 0, 522

    text(exo2_light_14, "Multiline (Enter = newline)", #aaaaaa): 0, 530
    placeholder(generated(cross(300, 60, #FF0000)), builderParameter("multilineInput")) {
        pos: 0, 548
        settings{buildName=>textInput, font=>dd, placeholder=>"Multiple lines...", multiline=>true, inputWidth=>240, width=>300}
    }

    text(exo2_light_14, "Alphanumeric only", #aaaaaa): 320, 530
    placeholder(generated(cross(200, 24, #FF0000)), builderParameter("alphanumericInput")) {
        pos: 320, 548
        settings{buildName=>textInput, font=>dd, placeholder=>"Letters + digits...", filter=>alphanumeric, inputWidth=>140}
    }
}
`,sf=`version: 1.0
...
layouts {
    ...
    #navCards list {
        ...
        point: 680, 568
        point: 840, 568
        // Animation & Effects (9, wraps to 2 rows)
        point: 40, 626
        point: 200, 626
        point: 360, 626
        point: 520, 626
