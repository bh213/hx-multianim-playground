 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(F,E){var R=F.length;F.push(E);e:for(;0<R;){var M=R-1>>>1,D=F[M];if(0<a(D,E))F[M]=E,F[R]=D,R=M;else break e}}function t(F){return F.length===0?null:F[0]}function r(F){if(F.length===0)return null;var E=F[0],R=F.pop();if(R!==E){F[0]=R;e:for(var M=0,D=F.length,In=D>>>1;M<In;){var te=2*(M+1)-1,je=F[te],ke=te+1,Ve=F[ke];if(0>a(je,R))ke<D&&0>a(Ve,je)?(F[M]=Ve,F[ke]=R,M=ke):(F[M]=je,F[te]=R,M=te);else if(ke<D&&0>a(Ve,R))F[M]=Ve,F[ke]=R,M=ke;else break e}}return E}function a(F,E){var R=F.sortIndex-E.sortIndex;return R!==0?R:F.id-E.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();e.unstable_now=function(){return o.now()-l}}var u=[],p=[],b=1,x=null,m=3,w=!1,S=!1,_=!1,P=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,s=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function c(F){for(var E=t(p);E!==null;){if(E.callback===null)r(p);else if(E.startTime<=F)r(p),E.sortIndex=E.expirationTime,n(u,E);else break;E=t(p)}}function f(F){if(_=!1,c(F),!S)if(t(u)!==null)S=!0,gt(h);else{var E=t(p);E!==null&&Mn(f,E.startTime-F)}}function h(F,E){S=!1,_&&(_=!1,d(y),y=-1),w=!0;var R=m;try{for(c(E),x=t(u);x!==null&&(!(x.expirationTime>E)||F&&!A());){var M=x.callback;if(typeof M=="function"){x.callback=null,m=x.priorityLevel;var D=M(x.expirationTime<=E);E=e.unstable_now(),typeof D=="function"?x.callback=D:x===t(u)&&r(u),c(E)}else r(u);x=t(u)}if(x!==null)var In=!0;else{var te=t(p);te!==null&&Mn(f,te.startTime-E),In=!1}return In}finally{x=null,m=R,w=!1}}var g=!1,v=null,y=-1,$=5,T=-1;function A(){return!(e.unstable_now()-T<$)}function de(){if(v!==null){var F=e.unstable_now();T=F;var E=!0;try{E=v(!0,F)}finally{E?nn():(g=!1,v=null)}}else g=!1}var nn;if(typeof s=="function")nn=function(){s(de)};else if(typeof MessageChannel<"u"){var ht=new MessageChannel,Sa=ht.port2;ht.port1.onmessage=de,nn=function(){Sa.postMessage(null)}}else nn=function(){P(de,0)};function gt(F){v=F,g||(g=!0,nn())}function Mn(F,E){y=P(function(){F(e.unstable_now())},E)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(F){F.callback=null},e.unstable_continueExecution=function(){S||w||(S=!0,gt(h))},e.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<F?Math.floor(1e3/F):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(u)},e.unstable_next=function(F){switch(m){case 1:case 2:case 3:var E=3;break;default:E=m}var R=m;m=E;try{return F()}finally{m=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(F,E){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var R=m;m=F;try{return E()}finally{m=R}},e.unstable_scheduleCallback=function(F,E,R){var M=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?M+R:M):R=M,F){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=R+D,F={id:b++,callback:E,priorityLevel:F,startTime:R,expirationTime:D,sortIndex:-1},R>M?(F.sortIndex=R,n(p,F),t(u)===null&&F===t(p)&&(_?(d(y),y=-1):_=!0,Mn(f,R-M))):(F.sortIndex=D,n(u,F),S||w||(S=!0,gt(h))),F},e.unstable_shouldYield=A,e.unstable_wrapCallback=function(F){var E=m;return function(){var R=m;m=E;try{return F.apply(this,arguments)}finally{m=R}}}})(hs);ms.exports=hs;var Hc=ms.exports;/**
 * @license React
...
relativeLayouts {
    ...
    #navCards list {
        ...
        point: 840, 330
        point: 1000, 330
        // UI Components (10, wraps to 2 rows)
        point: 40, 388
        point: 200, 388
        point: 360, 388
        point: 520, 388
...
#tab programmable(status:[hover, pressed, normal], checked:[true, false], disabled:[true, false], width:uint=120, height:uint=30, font="m6x11", fontColor:int=0xffffff12, buttonText="Tab") {
